...
(function (k) {
  ...
  u.defaults = {
    ...
    oLanguage: {
      oAria: {
        sSortAscending: ": Ative para organizar a coluna em ordem crescente",
        sSortDescending: ": Ative para organizar a coluna em ordem decrescente",
      },
      oPaginate: {
        sFirst: "Primeira",
        sLast: "Ultima",
      ...
      sInfoFiltered: "(filtered from _MAX_ total de registros)",
      sInfoPostFix: "",
      sDecimal: "",
      sThousands: ",",
